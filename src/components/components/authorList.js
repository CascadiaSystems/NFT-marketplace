  ...
  <div>
    <ol className="author_list">
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/1.png" alt="" />
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/2.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/3.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/4.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/5.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/6.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/7.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/8.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/9.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/10.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/11.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
      ...
      <li>
        <div className="author_list_pp">
          <span onClick={() => window.open("", "_self")}>
            <img className="lazy" src="./img/author/sophon/12.png" alt="" />
            <i className="fa fa-check"></i>
          </span>
        </div>
        <div className="author_list_info">
