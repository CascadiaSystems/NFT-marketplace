            ...
            <div className="de_form">
              <div className="de_checkbox">
                <input
                  ...
                  value="abstract"
                />
                <label htmlFor="abstract">Collection #6949</label>
              </div>
              ...
              <div className="de_checkbox">
                <input
                  ...
                  value="paterns"
                />
                <label htmlFor="paterns">Collection #2672</label>
              </div>
              ...
              <div className="de_checkbox">
                <input
                  ...
                  value="skecth"
                />
                <label htmlFor="skecth">Collection #2856</label>
              </div>
              ...
              <div className="de_checkbox">
                <input
                  ...
                  value="cartoon"
                />
                <label htmlFor="cartoon">Collection #7643</label>
              </div>
              ...
              <div className="de_checkbox">
                <input
                  ...
                  value="virtualand"
                />
                <label htmlFor="virtualand">Collection #5784</label>
              </div>
              ...
              <div className="de_checkbox">
                <input
                  ...
                  value="pappercut"
                />
                <label htmlFor="pappercut">Collection #0364</label>
              </div>
            </div>
          </div>
        </div>
